...
// createBlock.innerText = 'Okten - cool school!!!';
// // - додати йому класи wrap, collapse, alpha, beta
// createBlock.classList.add('wrap', 'collapse', 'alpha', 'beta')
// // - додати стилі(довільні значення) : колір фону, колір тексту, розмір тексту
// createBlock.style.backgroundColor = 'grey';
// createBlock.style.color = 'violet';
// createBlock.style.fontSize = '33px';
// // - додати цей блок в body.
// let body = document.querySelector('body');
// body.appendChild(createBlock);
// // - клонувати його повністю, та додати клон в body.
// let createClone = createBlock.cloneNode(true);
// body.appendChild(createClone)
...
//         div.innerText = `Title - ${item.title}, Month Duration - ${item.monthDuration}`;
...
//
//     h1.innerText = `${simpsonMember.name} ${simpsonMember.surname}`;
//     b.innerText = simpsonMember.age;
//     p.innerText = simpsonMember.info;
//     img.src = simpsonMember.photo;
//     div.append(h1, b, p, img)
//     body.appendChild(div)
// }
